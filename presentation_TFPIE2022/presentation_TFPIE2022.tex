...
\author{Kevin Kappelmann (presenting), Jonas Rädle (presenting), and\\Lukas Stevens} % Your name
...
\only<1>{\centerline{Code Golf}
\begin{figure}
\includegraphics[width=0.75\linewidth]{assets/golf1}
\end{figure}
\begin{figure}
\includegraphics[width=0.75\linewidth]{assets/golf2}
\end{figure}
}
