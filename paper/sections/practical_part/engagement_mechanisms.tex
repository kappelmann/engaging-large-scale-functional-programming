...
TODO: cite \cite{student_engagement}
...
almost all students that obtained the bonus
...
In each of the iterations, 144 different students ranked among the top 30 of the week at least once.
...
strategies~\cite{onlineengagement5,engagementproposals}
to increase engagement:
it is challenging, often practical, humorous,
and integrates gamification aspects.
Nevertheless, despite the work of our student assistants,
...
moving to a bi-weekly format,
or replacing it by more efficient mechanisms
that motivate talented students.
