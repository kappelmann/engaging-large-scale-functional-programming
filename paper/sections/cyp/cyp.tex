...
\kevin{TODO: mention strict and total subset for fast and loose reasoning}
...
Such simple proofs of course lend themselves well to be automatically checked and, as announced by \cite{next_1100}, a tool called ``Check Your Proof'' (CYP for short) was developed by Durner and Noschinski\footnote{\url{https://github.com/noschinl/cyp}}.
...
\lukas{Questions for Jonas: where the results for the computation induction better after introducing it to CYP? How well did the students do in the proof exercises compared to the rest of the exam?}
